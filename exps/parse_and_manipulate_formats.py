...
save_folder = os.path.join(os.path.dirname(os.path.dirname(__file__)), "download")
...
binary = lief.parse(os.path.join(save_folder,  "a"))

for section in binary.sections:
    print(binary.get_content_from_virtual_address(section.virtual_address, 100))
    print(section.name)
    print("===================================")
...
builder.build()
builder.write(os.path.join(os.path.dirname(os.path.dirname(__file__)), "download", "result.exe"))
